[![Brest Scopes](http://brest.rollingscopes.com/images/logo_rs_text.svg)](http://brest.rollingscopes.com/)
#Brest Rolling Scopes School
## Javascript Assignments  [![Build Status](https://travis-ci.org/AlexXer/js-assignments.svg?branch=master)](https://travis-ci.org/AlexXer/js-assignments)
...
```
* Open https://github.com/AlexXer/js-assignments and test the build icon. Now it will run all tests and update status once you push changes to github. Keep this icon green!
...
* Push your updates to github server and check if tests passed on [travis-ci](https://travis-ci.org/AlexXer/js-assignments/builds).
